...
public abstract class Boomer extends Plant{
    ...
    public Boomer(int x, int y, int speed, int price, int health, long waitingtime, int damage, double bulletwaitingtime, int row, int col) {
